...
hyp = {'giou': 1.582,  # giou loss gain
       ...
       'lr0': 0.001324,  # initial learning rate
...
def train():
    ...
    # Initialize model
    model = Darknet(cfg, img_size, arc=opt.arc).to(device)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        print("best_fitness: {} fitness: {}".format(best_fitness,fitness))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=11000)  # 500200 batches at bs 16, 117263 images = 273 epochs
    parser.add_argument('--batch-size', type=int, default=32)  # effective bs = batch_size * accumulate = 16 * 4 = 64
    parser.add_argument('--accumulate', type=int, default=2, help='batches to accumulate before optimizing')
    parser.add_argument('--cfg', type=str, default='/home/ubuntu/tray_data/cfg/tm4.cfg', help='cfg file path')
    parser.add_argument('--data', type=str, default='/home/ubuntu/tray_data/cfg/shuhan.data', help='*.data file path')
    parser.add_argument('--multi-scale', action='store_true', help='adjust (67% - 150%) img_size every 10 batches')
    parser.add_argument('--img-size', type=int, default=416, help='inference size (pixels)')
    parser.add_argument('--rect', action='store_true', help='rectangular training')
    parser.add_argument('--resume', action='store_true', help='resume training from last.pt')
    parser.add_argument('--reset_best', action='store_true', help='resume training from last.pt')
